...
const RejectedMaterials = () => {
  ...
  const handleView = id => {
    ...
    router.push({
      pathname: '/approving/lwm_approval',
      query: { id }
    });
  ...
  return (
    <>
      {isLoading && <Loading />}
      {user && user[ROLES].includes('LWM') ? (
        <div>
          <table className="table table-bordered">
            <thead>
              <tr style={{ background: '#b5bd36' }}>
                <td colSpan="13" className="text-center text-dark">
                  <h2> Materials waiting for LWM approval</h2>
                </td>
              </tr>
          ...
          <div>
            <div className="text-center">
              <Message
                ...
                className="border-warn text-dark w-full justify-content-start mb-3"
                severity="warn"
                content={'You dont have permissions to access this page'}
              />
            </div>
            <div className="text-center">
              <Message
                ...
                className="border-warn text-dark w-full justify-content-start mb-5"
                severity="error"
