...
const InspectionForm = () => {
  ...
  // All Variables
  const [selected_methods, setSelectedMethods] = useState([]);
                ...
                <td className="text-start" colSpan="6">
                  <div className="d-flex flex-column flex-md-row">
                    ...
                    <div className="col-12 col-md-6">
                      ...
                      <div>
                        Selected Methods:
                        {selected_methods.map(selectedMethod => {
                          const method = methods.find(method => method.code === selectedMethod);
                          return <div key={method.code}>{method.name}</div>;
                        })}
                      </div>
                    </div>
                  </div>
