...
import { methods, sampleItems, itemsList, sampleInspected, warehouseLocation, ROLES } from '../components/dataitems';
...
const InspectionForm = () => {
  ...
  const [insapection_technique, setSampleSelection] = useState('');
    ...
    <>
      ...
      {user && user[ROLES].includes('MIT') && (
        <div className="container">
              ...
              <tr>
                <td className="text- start" colSpan="6">
                  <div className="d-flex flex-column flex-md-row">
                    <div className="col-12 col-md-6">
                      <label htmlFor="Inspection" className="me-3">
                        Inspection technique:<span className="text-danger">*</span>
                      </label>
                    </div>
                    <div className="col-12 col-md-6">
                      <Dropdown
                        value={insapection_technique}
                        ...
                        required
                      />
                      {/* {insapection_technique ? insapection_technique.name : 'none'} */}
                    </div>
                  </div>
                </td>
                <td className="text-start" colSpan="2">
          ...
          {message && <p className="text-start text-success">{message}</p>}
      ...
      {!user ||
        (!user[ROLES].includes('MIT') && (
          <>
            <h3 className="text-start text-warning m-5">You dont have permissions to access this page</h3>
