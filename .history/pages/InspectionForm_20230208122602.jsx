...
import { methods, sampleItems, itemsList, sampleWhole, ROLES } from '../components/dataitems';
...
const InspectionForm = () => {
  ...
  const [total_inspected, setTotalInspected] = useState(0);
  const [total_pass, setTotalPass] = useState(0);
  const [total_failure, setTotalFailure] = useState(0);
  ...
  const sampleSelect = sampleWhole.map(item => item);
                  ...
                  <div className="d-flex flex-column flex-md-row">
                    ...
                    <div className="col-12 col-md-6">
                      <Dropdown
                        ...
                        onChange={e => setSampleSelection(e.value)}
                        optionLabel="name"
