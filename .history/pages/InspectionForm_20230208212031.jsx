...
import { methods, sampleItems, itemsList, sampleInspected, ROLES, showErro, showSucces } from '../components/dataitems';
...
const InspectionForm = () => {
  ...
  const toast = useRef(null); //on success data entry
  const showSuccess = showSucces;
  const showError = showErro;
