...
const form = () => {
  ...
  return (
    <>
              ...
              <div className="col-12 md:col-4">
                <div>
                  <label htmlFor="Delivery" className="me-3">
                    Delivery Date:
                    {showCalendar && <Calendar value={selectedDat} onChange={e => setSelectedDat(e.value)} />}
                  </label>
                  {showCalendar && (
                    <Calendar
                      value={deliveryDate}
      ...
      <div>{selectedDeliveryDate ? moment(selectedDeliveryDate).format('MMMM Do YYYY') : 'No date selected'}</div>
