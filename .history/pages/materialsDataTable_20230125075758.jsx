  ...
  return (
    <div>
        ...
        <div className="p-col-12">
          <div className="p-grid">
            <div className="p-col-6" style={{ textAlign: 'right' }}>
              <InputText
                type="text"
                style={{ backgroundColor: '#04392a', color: '#fff' }}
                className="me-2"
      ...
      <DataTable value={filterData()} paginator rows={4} responsive>
        <Column field="material_name" header="Material_Name" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="supplier_name" header="Supplier_Name" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="method_of_inspection" header="Inspection_Method" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="material_received" header="material_received" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="total_inspected" header="TotaI_Inspected" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="total_pass" header="Total_Pass" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="total_failure" header="Total_Fail" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="delivery_note" header="Delivery_Note" headerStyle={{ backgroundColor: '#04392a' }} />
        <Column field="sample_inspected" header="sample_inspected" headerStyle={{ backgroundColor: '#04392a' }} />
