...
import { methods, sampleItems, itemsList, ROLES } from '../components/dataitems';
                ...
                <td className="text-start" colSpan="6">
                  <div className="d-flex flex-column flex-md-row">
                    ...
                    <div className="col-12 col-md-6">
                      ...
                      <MultiSelect
                        value={method_of_inspection}
                        options={methods.map(method => ({ label: method.name, value: method.code }))}
                        onChange={e => setMethodOfInspection(e.value)}
                        placeholder="Methods of Inspection"
                        display="chip"
                      />
                      <div>
                        Selected Methods:
                        {method_of_inspection.map(method_of_inspection => {
                          const method = methods.find(method => method.code === method_of_inspection);
                          return <span key={method.code}>{method.name},</span>;
                        })}
                      </div>
                    </div>
                  </div>
