    ...
    <>
            ...
            <tbody>
              ...
              <tr>
                <td colSpan={8}>
                  ...
                  {message && <p className="text-end text-success">{message}</p>}
                </td>
              </tr>
            </tbody>
          </table>
      ...
      {!user ||
        (!user[ROLES].includes('MIT') && (
          <>
            <h3 className="text-end text-warning m-5">You dont have permissions to access this page</h3>
            <h3 className="text-end text-warning m-5">Request for permissions</h3>
          </>
        ))}
    </>
  );
