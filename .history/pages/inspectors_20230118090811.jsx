...
const form = () => {
 ...
 <table className="table table-bordered">
  <thead className=''>
    <tr>
      <th className='text-center' colSpan="8"><h3> Material Quality Inspectors </h3></th>
    </tr>
  </thead>
  <tbody>
...
<tr>
  ...
  <td colSpan={2} className='text-center'>   { showCalendar && <Calendar value={selectedDate} onChange={onDateSelect} showButtonBar={true} showTime={false} dateFormat="yy-mm-dd" /> }</td>
</tr>
 ...
 <span className='text-warning'>{textValue}</span>Selected Date: <span className='text-warning'> {selectedDate ? moment(selectedDate).fromNow() : 'No date'}</span>
