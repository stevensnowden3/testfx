...
const form = () => {
  ...
  return (
    <>
      ...
      <span className="text-warning m-2">{textValue}</span> Delivery date
      ...
      <table class="table table-bordered">
        <tbody>
          <tr>
            <td>Method{selectedMethod ? selectedMethod.name : 'none'}</td>
            <td>Sample: {selectedSample ? selectedSample.name : 'none'}</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
