  ...
  try {
    ...
    try {
      const [result] = await connection.execute(
        'INSERT INTO checklisttest (material_name, supplier_name,method_of_inspection) VALUES (?, ?,? )',
        [req.body.material_name, req.body.supplier_name, req.body.method_of_inspection]
      );
      if (result) {
