...
export default async (req, res) => {
  try {
    ...
    const [result] = await connection.execute(
      'INSERT INTO checklist (material_name, supplier_name, method_of_inspection, material_received, total_inspected, total_pass, total_failure, delivery_note, sample_inspected, delivery_date, inspectiondate, filename, remark) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
      [
