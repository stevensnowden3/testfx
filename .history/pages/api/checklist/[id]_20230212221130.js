  ...
  try {
    ...
    if (req.method === 'DELETE') {
      ...
      // Update the selected row
        ...
        await connection.execute(
          'UPDATE checklisttest SET material_name = ?, supplier_name = ?, method_of_inspection = ?,inspection_technique=?, material_received = ?, total_inspected = ?, total_pass = ?, total_failure = ?,remark = ?, status = "TCO" WHERE id = ?',
          [
            material_name,
            supplier_name,
            method_of_inspection,
