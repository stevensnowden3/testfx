  ...
  try {
    ...
    if (req.method === 'DELETE') {
      ...
      // Update the selected row
        ...
        await connection.execute(
          'UPDATE checklisttest SET material_name = ?, supplier_name = ?, method_of_inspection = ?,sample_selection=?, material_received = ?, total_inspected = ?, total_pass = ?, total_failure = ?,remark = ? WHERE id = ?',
          [
            material_name,
            supplier_name,
            method_of_inspection,
