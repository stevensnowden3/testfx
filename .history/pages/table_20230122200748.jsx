...
const DataTableExample = () => {
  ...
  return (
    <div>
      ...
      <DataTable value={filterData()} className="checklistTable" paginator rows={4}>
        <Column field="material_name" className="checklistTable" header="Material Name" />
        <Column field="supplier_name" className="checklistTable" header="Supplier Name" />
        <Column field="method+of_inspection" header="Method of Inspection" />
