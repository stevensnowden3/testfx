...
const MyComponent = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
        if (!material_name || !supplier_name || !method_of_inspection || !material_received || !total_inspected || !total_pass || !total_failure || !delivery_note || !sample_inspected || !delivery_date || !inspection_date || !filename || !remark) {
