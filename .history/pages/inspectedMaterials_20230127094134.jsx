...
const MyComponent = () => {
  ...
  const printDocument = () => {
    ...
    var doc = new jsPDF();
    doc.text('Materials Inspection Report', 14, 16, { align: 'center', background: '#ff0000', marginBottom: 10 });
    doc.autoTable({
      head: [
        [
          'Material Name',
  ...
  return (
    <div id="divToPrint">
      ...
      <Button className="p-button-raised p-button-secondary p-button-text" aria-label="Google">
        <i className="pi-file-pdf"></i>
