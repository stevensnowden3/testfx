  ...
  return (
    <div>
      ...
      <DataTable value={filterData()} paginator rows={4} responsive>
        <Column field="material_name" header="Material_Name" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="supplier_name" header="Supplier_Name" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="method_of_inspection" header="Inspection Method" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="material_received" header="material_received" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="total_inspected" header="TotaI_Inspected" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="total_pass" header="Total_Pass" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="total_failure" header="Total_Fail" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="delivery_note" header="Delivery_Note" headerStyle={{ backgroundColor: '#b5bd36' }} />
        <Column field="sample_inspected" header="sample_inspected" headerStyle={{ backgroundColor: '#b5bd36' }} />
