...
const accept = () => {
  ...
  toast.current.show({ severity: 'info', summary: 'Confirmed', detail: 'Approval Confirmed!', life: 3000 });
};
...
export { methods, sampleItems, itemsList, ROLES, sampleInspected, tinykey, warehouseLocation, reject, accept };
