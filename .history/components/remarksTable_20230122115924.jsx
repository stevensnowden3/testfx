...
const RemarksTable = ({ selectedSample, param, handleEditorContent }) => {
  ...
  tableHtml += '<thead><tr><th>Umeme Requiremens</th><th>Comment/Remark</th></tr></thead>';
  tableHtml += '<tbody>';
  ...
  tableHtml += '</tbody></table> <h2 className="mt-3 text-"> Write a brief comment on Material(s):</h2></div> ';
