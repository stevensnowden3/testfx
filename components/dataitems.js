...
const materialsReceived = [
  { name: 'New Delivery', code: 'a' },
  { name: 'Return', code: 'b' },
  { name: 'Repaired', code: 'd' }
];
var ROLES = 'https://netlify-integration.com/roles';
const sampleItems = [
  { name: 'Single Phase Prepayment Meters- Inhemeter', code: 'a' },
...
export { methods, sampleItems, itemsList, ROLES, sampleInspected, tinykey, warehouseLocation, materialsReceived };
